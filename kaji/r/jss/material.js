    ...
    function (a) {
        a.fn.collapsible = function (b, c) {
            ...
            return b = a.extend(d, b), this.each(function () {
                function d(b) {
                    m = l.find("> li > .collapsible-header"), b.hasClass("active") ? b.parent().addClass("active") : b.parent().removeClass("active"), b.parent().hasClass("active") ? b.siblings(".collapsible-arti").stop(!0, !1).slideDown({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1,
                        complete: function () {
                    ...
                    }) : b.siblings(".collapsible-arti").stop(!0, !1).slideUp({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1,
                        complete: function () {
                    ...
                    }), m.not(b).removeClass("active").parent().removeClass("active"), m.not(b).parent().children(".collapsible-arti").stop(!0, !1).each(function () {
                ...
                function f(b) {
                    b.hasClass("active") ? b.parent().addClass("active") : b.parent().removeClass("active"), b.parent().hasClass("active") ? b.siblings(".collapsible-arti").stop(!0, !1).slideDown({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1,
                        complete: function () {
                ...
                return this.each(function (c) {
                    ...
                    b.swipeable && l > b.responsiveThreshold && (b.swipeable = !1), e = a(m.filter('[href="' + location.hash + '"]')), 0 === e.length && (e = a(this).find("li.tab a.active").first()), 0 === e.length && (e = a(this).find("li.tab a").first()), e.addClass("active"), q = m.index(e), q < 0 && (q = 0), void 0 !== e[0] && (f = a(e[0].hash), f.addClass("active")), k.find(".indicator").length || k.append('<li class="indicator"></li>'), h = k.find(".indicator"), k.append(h), k.is(":visible") && setTimeout(function () {
                        ...
                        if (!a(this).attr("target")) {
                            ...
                            e.position();
                            e.addClass("active"), prev_index = q, q = m.index(a(this)), q < 0 && (q = 0), b.swipeable ? o.length && o.carousel("set", q, function () {
        ...
        a.fn.tooltip = function (c) {
            ...
            return "remove" === c ? (this.each(function () {
                ...
                var d = Materialize.guid(),
                    e = a(this);
                e.attr("data-tooltip-id") && a("#" + e.attr("data-tooltip-id")).remove(), e.attr("data-tooltip-id", d);
                ...
                }(), e.off("mouseenter.tooltip mouseleave.tooltip");
                var m, n = !1;
                e.on({
                ...
                return this.each(function (c) {
                    ...
                    function h(c) {
                        ...
                        if ((!b.noWrap || t >= 0 && t < w) && (j = p[g(t)], j.style[E] = k + " translateX(" + -f / 2 + "px) translateX(" + h * b.shift * i + "px) translateZ(" + b.dist * i + "px)", j.style.zIndex = 0, b.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * i, j.style.opacity = tweenedOpacity, j.style.display = "block"), l !== t && "function" == typeof b.onCycleTo) {
                            var o = O.find(".carousel-item").eq(g(t));
                    ...
                    function l(a) {
                        var c = t % w - a;
                        b.noWrap || (c < 0 ? Math.abs(c + w) < Math.abs(c) && (c += w) : c > 0 && Math.abs(c - w) < c && (c -= w)), c < 0 ? O.trigger("carouselNext", [Math.abs(c)]) : c > 0 && O.trigger("carouselPrev", [c])
                    }
                    ...
                    if (b.fullWidth && (b.dist = 0, function () {
                        ...
                        }(), P && O.find(".carousel-fixed-item").addClass("with-indicators")), O.hasClass("initialized")) return a(window).trigger("resize"), a(this).trigger("carouselNext", [1e-6]), !0;
                    O.addClass("initialized"), u = !1, s = B = 0, p = [], q = O.find(".carousel-item").first().innerWidth(), r = O.find(".carousel-item").first().innerHeight(), v = 2 * q + b.padding, O.find(".carousel-item").each(function (b) {
